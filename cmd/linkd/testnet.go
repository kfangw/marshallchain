...
func InitTestnet(cmd *cobra.Command, config *tmconfig.Config, cdc *codec.Codec,
	...
	nsConfig := srvconfig.DefaultConfig()
	nsConfig.MinGasPrices = minGasPrices
	...
	for i := 0; i < numValidators; i++ {
		...
		nsConfigFilePath := filepath.Join(nodeDir, "config/linkd.toml")
		srvconfig.WriteConfigFile(nsConfigFilePath, nsConfig)
	}
